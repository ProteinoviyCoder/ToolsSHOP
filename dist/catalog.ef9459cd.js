...
})({"dt3rV":[function(require,module,exports) {
var global = arguments[3];
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d6ea1d42532a7575";
module.bundle.HMR_BUNDLE_ID = "763de7d8ef9459cd";
"use strict";
...
},{}],"jZAhG":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
// Страница каталога
parcelHelpers.export(exports, "getCatalogPage", ()=>getCatalogPage);
var _catalogCss = require("/src/js/pages/catalog/catalog.css");
var _categoriesJs = require("/src/js/components/categories/categories.js");
...
var _brandsJs = require("/src/js/components/brands/brands.js");
var _searchJs = require("/src/js/components/search/search.js");
function getCatalogPage(categoryNavigo) {
    //делаем страницу
    ...
    const data = (0, _productListJs.getProductList)();
    //создаём бренды и передаём туда 1-местонахождение в категории; 2-место куда вставлять карточки товара/бренды
    const brands = (0, _brandsJs.getBrands)(categoryNavigo, data.list);
    //создаём категории
    const categories = (0, _categoriesJs.getCategories)();
    ...
    async function createCatalogList() {
        ...
        if (categoryNavigo == "\u0412\u0441\u0435") {
            ...
            for (let i of allItemCategories){
                ...
                if (i.childNodes[1].textContent === "") i.classList.add("active");
            }
            for(let i in result){
                const product = (0, _productCardJs.getProductCard)(result[i].name, result[i].price, result[i].desc, result[i].imgSmall, result[i].id, result[i].countBasketBoolean);
            ...
            for (let i of allItemCategories){
                i.classList.remove("active");
                if (i.childNodes[1].textContent === categoryNavigo) i.classList.add("active");
            }
            for(let i in result)if (categoryNavigo === result[i].categoryENG) {
                const product = (0, _productCardJs.getProductCard)(result[i].name, result[i].price, result[i].desc, result[i].imgSmall, result[i].id, result[i].countBasketBoolean);
                data.list.append(product);
            }
        }
    ...
    if (data.list.childNodes.length > 29) {
        ...
        for (let i of products){
            ...
            if (flagProduct > 29) i.classList.add("catalog__none");
        }
        ...
        btnElse.addEventListener("click", function() {
            ...
            const products = data.list.querySelectorAll(".product-list__item.catalog__none");
            const countProduct = productss.length - products.length + 30;
            productFlag = 0;
            for (let i of productss){
                productFlag = productFlag + 1;
                if (productFlag <= countProduct) i.classList.remove("catalog__none");
            }
            if (data.list.querySelectorAll(".product-list__item.catalog__none").length === 0) btnElse.classList.add("catalog__none");
        });
...
},{"/src/js/pages/catalog/catalog.css":"9Fmh7","/src/js/components/categories/categories.js":"aQgfV","/src/js/components/mainTitle/mainTitle.js":"ki5if","/src/js/components/productList/productList.js":"lAenc","/src/js/components/productCard/productCard.js":"9WzTu","/src/js/components/brands/brands.js":"7QwiN","/src/js/components/search/search.js":"7PvpJ","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"9Fmh7":[function() {},{}],"aQgfV":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "getCategories", ()=>getCategories);
var _categoriesCss = require("/src/js/components/categories/categories.css");
...
function getCategories() {
    ...
    const titleCategories = (0, _semiTitleJs.getSemiTitle)("\u041A\u0430\u0442\u0435\u0433\u043E\u0440\u0438\u0438");
    ...
    document.addEventListener("scroll", function() {
        if (categoriesModule.getBoundingClientRect().top < 0 && flagBlockCategoru === false) {
...
},{"/src/js/components/categories/categories.css":"1FWnO","/src/js/components/semiTitle/semiTitle.js":"5vYXl","/src/js/main.js":"1SICI","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"1FWnO":[function() {},{}],"5vYXl":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"/src/js/components/semiTitle/semiTitle.css":"7Bj18","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"7Bj18":[function() {},{}],"ki5if":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
// Создаёт главный заголовок
...
},{"/src/js/components/mainTitle/mainTitle.css":"8xezA","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"8xezA":[function() {},{}],"9WzTu":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
// Создаём карточку товара
parcelHelpers.export(exports, "getProductCard", ()=>getProductCard);
var _productCardCss = require("/src/js/components/productCard/productCard.css");
...
function getProductCard(title, price, desc, img, id, countBasketBoolean) {
    ...
    image.addEventListener("click", function(event) {
        ...
        (0, _mainJs.router).navigate(`/product/${id}`);
    });
    const productTitle = document.createElement("h2");
    productTitle.classList.add("product-list__title");
    let productLink = (0, _navigationLinkJs.getNavigationLink)(`/product/${id}`, title);
    ...
    addBasket.addEventListener("click", function() {
        if (JSON.parse(localStorage.getItem("basket")) != null) {
            ...
            for (let i of basket)if (i.name === title) {
                valueBasket = false;
                i.value = i.value + 1;
            }
    ...
    const countBasket = (0, _countBasketJs.getCountBasket)(title, addBasket, price, productPrice);
...
},{"/src/js/components/productCard/productCard.css":"8FtH3","/src/js/components/navigationLink/navigationLink.js":"9DXZC","/src/js/main.js":"1SICI","/src/js/components/countBasket/countBasket.js":"aYsRB","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"8FtH3":[function() {},{}],"aYsRB":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"/src/js/components/countBasket/countBasket.css":"ix9RU","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"ix9RU":[function() {},{}],"7QwiN":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "getBrands", ()=>getBrands);
var _brandsCss = require("/src/js/components/brands/brands.css");
var _productCardJs = require("/src/js/components/productCard/productCard.js");
function getBrands(categoryNavigo, place) {
    ...
    function createBrand(nameBrand) {
        ...
        if (brand.textContent == "\u0412\u0421\u0415") brand.classList.add("active-brand");
        brand.addEventListener("click", async function() {
            ...
            for (let i of allBtnBrands)i.classList.remove("active-brand");
                ...
                if (categoryNavigo != "\u0412\u0441\u0435") {
                    ...
                    if (brand.textContent != "\u0412\u0421\u0415") {
                        if (result[i].brand != undefined) {
                            if (result[i].brand.toUpperCase() === brand.textContent && result[i].categoryENG === categoryNavigo) {
                                const product = (0, _productCardJs.getProductCard)(result[i].name, result[i].price, result[i].desc, result[i].imgSmall, result[i].id, result[i].countBasketBoolean);
            ...
            if (place.innerHTML == "" || place.innerHTML == null) {
                ...
                notFoundText.textContent = "\u041F\u043E\u0445\u043E\u0436\u0435 \u0442\u0430\u043A\u043E\u0433\u043E \u0443 \u043D\u0430\u0441 \u043D\u0435\u0442, \u043F\u043E\u043F\u0440\u043E\u0431\u0443\u0439\u0442\u0435 \u043F\u043E\u0438\u0441\u043A\u0430\u0442\u044C \u0434\u0440\u0443\u0433\u043E\u0439 \u0431\u0440\u0435\u043D\u0434 :)";
    ...
    for (let i of allBtnBrands)if (i.textContent == "\u0412\u0441\u0435") i.classList.add("active-brand");
    return listBrand;
}

},{"/src/js/components/brands/brands.css":"ceaJT","/src/js/components/productCard/productCard.js":"9WzTu","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"ceaJT":[function() {},{}],"7PvpJ":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "getSearch", ()=>getSearch);
var _searchCss = require("/src/js/components/search/search.css");
var _mainJs = require("/src/js/main.js");
function getSearch() {
    ...
    for(let i in dataCard){
        ...
        helpItem.addEventListener("click", function() {
            (0, _mainJs.router).navigate(`/product/${dataCard[i].id}`);
        });
        helpList.append(helpItem);
    }
    searchBlock.append(search, helpList);
    search.addEventListener("input", function(event) {
        if (event.target.value == "") helpList.classList.add("search__none");
        else helpList.classList.remove("search__none");
        ...
        for (let i of allHelpItem){
            ...
            for (let x of arraySearch){
                if (i.textContent.search(x.toUpperCase()) == -1) valueSearch = false;
                if (valueSearch === true) i.classList.remove("search__none");
                else if (valueSearch === false) i.classList.add("search__none");
            }
        }
        let valueFerstItem = true;
        for (let i of allHelpItem)if (!i.classList.contains("search__none")) valueFerstItem = false;
        if (valueFerstItem === true) firstItem.classList.remove("search__none");
        else firstItem.classList.add("search__none");
    });
    document.addEventListener("click", function(e) {
        const close = e.composedPath().includes("help-list");
        if (!close) {
            const helpList = document.querySelector(".help-list");
            if (helpList != undefined) helpList.classList.add("search__none");
        }
    });
    return searchBlock;
}

},{"/src/js/components/search/search.css":"g21RR","/src/js/main.js":"1SICI","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"g21RR":[function() {},{}]},["dt3rV"], null, "parcelRequire8cce")

//# sourceMappingURL=catalog.ef9459cd.js.map
