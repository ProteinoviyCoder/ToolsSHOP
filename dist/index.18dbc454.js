...
var _productListJs = require("/src/js/components/productList/productList.js");
const router = new (0, _navigoDefault.default)("/");
async function renderPge() {
    await (0, _productListJs.getProductList)().dataBase();
    ...
    router.on("/", async ()=>{
        ...
        const moduleMain = await require("c3e3dc874438f71b");
    ...
    router.on("/catalog/", async ()=>{
        pageContainer.innerHTML = "";
        const moduleCatalog = await require("d9de322baf244975");
    ...
    router.on("/basket", async ()=>{
        pageContainer.innerHTML = "";
        const moduleBasket = await require("38d8b8de8efb0bb6");
    ...
    router.on(`/product/:id`, async ({ data })=>{
        pageContainer.innerHTML = "";
        const moduleProduct = await require("7d4719423e7e1150");
        const productPage = await moduleProduct.getProductPage(data.id);
        pageContainer.append(productPage);
    });
    //страница оформления
    router.on(`/order`, async ()=>{
        if (localStorage.getItem("basket") === null || JSON.parse(localStorage.getItem("basket")).length == 0) router.navigate("/catalog");
        else {
            pageContainer.innerHTML = "";
            const moduleOrder = await require("a2371ef72ac4f3fd");
    ...
    router.notFound(async ()=>{
        pageContainer.innerHTML = "";
        const notFoundModule = await require("df8b29315ae5bbe1");
...
},{"navigo":"fuSlc","/src/js/components/header/header.js":"k3piG","/src/js/components/pageContainer/pageContainer.js":"ht0nH","/src/js/components/productList/productList.js":"lAenc","c3e3dc874438f71b":"68UZ3","d9de322baf244975":"71ZhQ","38d8b8de8efb0bb6":"8t7Ip","7d4719423e7e1150":"ekACa","a2371ef72ac4f3fd":"3ujbK","df8b29315ae5bbe1":"4tjqN","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"fuSlc":[function(require,module,exports) {
!function(t, n) {
    module.exports = n();
...
var _headerCss = require("/src/js/components/header/header.css");
...
},{"/src/js/components/header/header.css":"39x7f","/src/js/components/navigationLink/navigationLink.js":"9DXZC","/src/js/components/logo/logo.js":"3UqdW","/src/js/components/basketBtn/basketBtn.js":"fnQNK","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"39x7f":[function() {},{}],"9DXZC":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
var _navigationLinkCss = require("/src/js/components/navigationLink/navigationLink.css");
...
},{"/src/js/main.js":"1SICI","/src/js/components/navigationLink/navigationLink.css":"arnVZ","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"arnVZ":[function() {},{}],"gkKU3":[function(require,module,exports) {
...
var _logoCss = require("/src/js/components/logo/logo.css");
...
function getLogo() {
    ...
    logo.src = (0, _logoPngDefault.default);
...
},{"/src/js/components/logo/logo.css":"fgPjk","/src/assets/img/logo.png":"lcmCO","/src/js/main.js":"1SICI","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"fgPjk":[function() {},{}],"lcmCO":[function(require,module,exports) {
module.exports = require("5446826d0a2ba832").getBundleURL("10Mjw") + "logo.7c849107.png" + "?" + Date.now();

},{"5446826d0a2ba832":"lgJ39"}],"lgJ39":[function(require,module,exports) {
"use strict";
var bundleURL = {};
...
var _basketPng = require("/src/assets/img/basket.png");
var _basketPngDefault = parcelHelpers.interopDefault(_basketPng);
var _basketBtnCss = require("/src/js/components/basketBtn/basketBtn.css");
var _mainJs = require("/src/js/main.js");
function getBasketBtn() {
    ...
    imgBasketBtn.src = (0, _basketPngDefault.default);
    basketBtn.append(imgBasketBtn);
    return basketBtn;
}

},{"/src/assets/img/basket.png":"ouBFh","/src/js/components/basketBtn/basketBtn.css":"c11TG","/src/js/main.js":"1SICI","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"ouBFh":[function(require,module,exports) {
module.exports = require("42e3632650b7593f").getBundleURL("10Mjw") + "basket.119f3ef2.png" + "?" + Date.now();

},{"42e3632650b7593f":"lgJ39"}],"c11TG":[function() {},{}],"ht0nH":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
// Контейнер для страниц
parcelHelpers.export(exports, "getPageContainer", ()=>getPageContainer);
var _pageContainerCss = require("/src/js/components/pageContainer/pageContainer.css");
...
},{"/src/js/components/pageContainer/pageContainer.css":"cl5cT","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"cl5cT":[function() {},{}],"lAenc":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "getProductList", ()=>getProductList);
var _productListCss = require("/src/js/components/productList/productList.css");
function getProductList() {
    const list = document.createElement("ul");
    list.classList.add("product-list");
    const dataBase = async function getDataFromBase() {
        try {
            const request = await fetch(`https://toolshop-610e8-default-rtdb.firebaseio.com/tools.json`);
            const rep = await request.json();
            const result = {};
            for(let i in rep){
                for(let x in rep[i])if (rep[i][x] == null) {
                    let y = 0;
                } else result[rep[i][x].id] = rep[i][x];
            }
            if (JSON.parse(localStorage.getItem("basket")) != null) {
                const basket = JSON.parse(localStorage.getItem("basket"));
                for(let i in result){
                    for (let x of basket)if (result[i].name == x.name) result[i].countBasketBoolean = true;
                }
            }
...
},{"/src/js/components/productList/productList.css":"1YWjZ","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"1YWjZ":[function() {},{}],"68UZ3":[function(require,module,exports) {
module.exports = Promise.all([
    require("ac18245a2d810bf7")(require("f1485d7f9d76e711").getBundleURL("10Mjw") + "main.58337d45.css" + "?" + Date.now()).catch((err)=>{
        delete module.bundle.cache[module.id];
        throw err;
    }),
    require("a5c4041558a00956")(require("f1485d7f9d76e711").getBundleURL("10Mjw") + "main.03d338dc.js" + "?" + Date.now()).catch((err)=>{
        delete module.bundle.cache[module.id];
        throw err;
    })
]).then(()=>module.bundle.root("4vpCS"));

},{"ac18245a2d810bf7":"1MWPE","f1485d7f9d76e711":"lgJ39","a5c4041558a00956":"61B45"}],"1MWPE":[function(require,module,exports) {
"use strict";
...
},{"ca2a84f7fa4a3bb0":"j49pS"}],"71ZhQ":[function(require,module,exports) {
module.exports = Promise.all([
    require("4fea0ea4e6b9d455")(require("fa8a734ef575fdfc").getBundleURL("10Mjw") + "main.58337d45.css" + "?" + Date.now()).catch((err)=>{
        delete module.bundle.cache[module.id];
        throw err;
    }),
    require("4fea0ea4e6b9d455")(require("fa8a734ef575fdfc").getBundleURL("10Mjw") + "catalog.5939e6a7.css" + "?" + Date.now()).catch((err)=>{
        delete module.bundle.cache[module.id];
        throw err;
    }),
    require("fc60971f7b398fe6")(require("fa8a734ef575fdfc").getBundleURL("10Mjw") + "catalog.ef9459cd.js" + "?" + Date.now()).catch((err)=>{
        delete module.bundle.cache[module.id];
        throw err;
    })
]).then(()=>module.bundle.root("jZAhG"));

},{"4fea0ea4e6b9d455":"1MWPE","fa8a734ef575fdfc":"lgJ39","fc60971f7b398fe6":"61B45"}],"8t7Ip":[function(require,module,exports) {
module.exports = Promise.all([
    require("c788c52252883f04")(require("d210a828c08dadad").getBundleURL("10Mjw") + "catalog.5939e6a7.css" + "?" + Date.now()).catch((err)=>{
        delete module.bundle.cache[module.id];
        throw err;
    }),
    require("c788c52252883f04")(require("d210a828c08dadad").getBundleURL("10Mjw") + "main.58337d45.css" + "?" + Date.now()).catch((err)=>{
        delete module.bundle.cache[module.id];
        throw err;
    }),
    require("c788c52252883f04")(require("d210a828c08dadad").getBundleURL("10Mjw") + "basket.69ddee09.css" + "?" + Date.now()).catch((err)=>{
        delete module.bundle.cache[module.id];
        throw err;
    }),
    require("e16b5caed832929d")(require("d210a828c08dadad").getBundleURL("10Mjw") + "basket.a5a31b23.js" + "?" + Date.now()).catch((err)=>{
        delete module.bundle.cache[module.id];
        throw err;
    })
]).then(()=>module.bundle.root("3HGJW"));

},{"c788c52252883f04":"1MWPE","d210a828c08dadad":"lgJ39","e16b5caed832929d":"61B45"}],"ekACa":[function(require,module,exports) {
module.exports = Promise.all([
    require("503da149f8e39b16")(require("e8af34dba1ef3f5a").getBundleURL("10Mjw") + "catalog.5939e6a7.css" + "?" + Date.now()).catch((err)=>{
        delete module.bundle.cache[module.id];
        throw err;
    }),
    require("503da149f8e39b16")(require("e8af34dba1ef3f5a").getBundleURL("10Mjw") + "main.58337d45.css" + "?" + Date.now()).catch((err)=>{
        delete module.bundle.cache[module.id];
        throw err;
    }),
    require("503da149f8e39b16")(require("e8af34dba1ef3f5a").getBundleURL("10Mjw") + "product.2eb8b8c8.css" + "?" + Date.now()).catch((err)=>{
        delete module.bundle.cache[module.id];
        throw err;
    }),
    require("1e77fee037937ed6")(require("e8af34dba1ef3f5a").getBundleURL("10Mjw") + "product.68e7d7ce.js" + "?" + Date.now()).catch((err)=>{
        delete module.bundle.cache[module.id];
        throw err;
    })
]).then(()=>module.bundle.root("ewuMC"));

},{"503da149f8e39b16":"1MWPE","e8af34dba1ef3f5a":"lgJ39","1e77fee037937ed6":"61B45"}],"3ujbK":[function(require,module,exports) {
module.exports = Promise.all([
    require("1194a3ba16e7608")(require("e070e01076372215").getBundleURL("10Mjw") + "product.2eb8b8c8.css" + "?" + Date.now()).catch((err)=>{
        delete module.bundle.cache[module.id];
        throw err;
    }),
    require("1194a3ba16e7608")(require("e070e01076372215").getBundleURL("10Mjw") + "order.71a8cfb0.css" + "?" + Date.now()).catch((err)=>{
        delete module.bundle.cache[module.id];
        throw err;
    }),
    require("d62f1940ab60c0fd")(require("e070e01076372215").getBundleURL("10Mjw") + "order.6d507a9b.js" + "?" + Date.now()).catch((err)=>{
        delete module.bundle.cache[module.id];
        throw err;
    })
]).then(()=>module.bundle.root("6az6x"));

},{"1194a3ba16e7608":"1MWPE","e070e01076372215":"lgJ39","d62f1940ab60c0fd":"61B45"}],"4tjqN":[function(require,module,exports) {
module.exports = Promise.all([
    require("60450998244da592")(require("ea62f4b081edb319").getBundleURL("10Mjw") + "product.2eb8b8c8.css" + "?" + Date.now()).catch((err)=>{
        delete module.bundle.cache[module.id];
        throw err;
    }),
    require("60450998244da592")(require("ea62f4b081edb319").getBundleURL("10Mjw") + "main.58337d45.css" + "?" + Date.now()).catch((err)=>{
        delete module.bundle.cache[module.id];
        throw err;
    }),
    require("8ada1469b34815f8")(require("ea62f4b081edb319").getBundleURL("10Mjw") + "404.c202ef6d.js" + "?" + Date.now()).catch((err)=>{
        delete module.bundle.cache[module.id];
        throw err;
    })
]).then(()=>module.bundle.root("kn7M6"));

},{"60450998244da592":"1MWPE","ea62f4b081edb319":"lgJ39","8ada1469b34815f8":"61B45"}]},["46McK","1SICI"], "1SICI", "parcelRequire8cce")
