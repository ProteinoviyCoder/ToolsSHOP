...
})({"iFcLZ":[function(require,module,exports) {
var global = arguments[3];
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d6ea1d42532a7575";
module.bundle.HMR_BUNDLE_ID = "ed6bc91d6d507a9b";
"use strict";
...
},{}],"6az6x":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
// Страница каталога
parcelHelpers.export(exports, "getOrderPage", ()=>getOrderPage);
var _orderCss = require("/src/js/pages/order/order.css");
var _noPhotoPng = require("/src/assets/img/noPhoto.png");
var _noPhotoPngDefault = parcelHelpers.interopDefault(_noPhotoPng);
...
function getOrderPage() {
    ...
    inputPhone.addEventListener("input", function() {
        ...
        let formatted = "+7";
        if (cleaned.length > 0) formatted += " " + cleaned.substring(1, 4);
        if (cleaned.length > 3) formatted += " " + cleaned.substring(4, 7);
        if (cleaned.length > 6) formatted += "-" + cleaned.substring(7, 9);
        if (cleaned.length > 8) formatted += "-" + cleaned.substring(9, 11);
    ...
    let productsArray = [];
    for (let i of dataProducts)if (i.remain === true) {
        let data = `<p class="order__product">${i.name} - <span class="order__span-products">${i.value}\u{448}\u{442}</span> </p>`;
        productsArray.push(data);
    }
    for (let z of productsArray)placeProducts.insertAdjacentHTML("beforeend", z);
...
},{"/src/js/pages/order/order.css":"klAdR","/src/assets/img/noPhoto.png":"1Z9PW","/src/js/components/btnBackHistory/btnBackHistory.js":"g4i62","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"klAdR":[function() {},{}],"1Z9PW":[function(require,module,exports) {
module.exports = require("72304914320aa17d").getBundleURL("knMLJ") + "noPhoto.c0461028.png" + "?" + Date.now();

},{"72304914320aa17d":"lgJ39"}],"g4i62":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"/src/js/components/btnBackHistory/btnBackHistory.css":"hbjLu","/src/assets/img/arrowLeft.png":"4fz3n","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"hbjLu":[function() {},{}],"4fz3n":[function(require,module,exports) {
module.exports = require("20d568ac8923e95d").getBundleURL("knMLJ") + "arrowLeft.846d34f0.png" + "?" + Date.now();

},{"20d568ac8923e95d":"lgJ39"}]},["iFcLZ"], null, "parcelRequire8cce")

//# sourceMappingURL=order.6d507a9b.js.map
